...
LIBRARY=(OUT/'physiology-v2')/('libmemory.dylib' if sys.platform=='darwin' else 'libmemory.so')
MODEL='all-modulators-separated-v2'
...
class MemoryBrain(NativeBrain):
    def __init__(self,path=GRAPH,*,eta=.001,circuit=None,modulation_mask=None):
        super().__init__(path)
